...
/datum/human_ai_squad_preset/clf/patrol
	...
	desc = "A rebel patrol armed with Bizon SMGs, MAR variant rifles and uncommonly an F90 rifle and AK4047, and carrying IFAKs with gauze, ointment and injectors."
	ai_to_spawn = list(
...
/datum/human_ai_squad_preset/clf/at
	...
	desc = "A rebel patrol with a few M83 SADAR launchers and armed with a Bizon SMG, MAR variant rifle and uncommonly an F90 rifle and AK4047, and carrying IFAKs with gauze, ointment and injectors."
	ai_to_spawn = list(
...
/datum/human_ai_squad_preset/clf/fortified
	...
	desc = "Best utilized for defensive positions; armed with a M240A1 incinerator, Bizon SMGs, MAR variant rifles, uncommonly a F90 and AK4047, and ample medical supplies."
	ai_to_spawn = list(
		/datum/equipment_preset/clf/soldier = 2,
...
/datum/human_ai_squad_preset/clf/leader_escort
	...
	desc = "A rebel patrol armed with a Bizon SMG, MAR variant rifle and uncommonly an F90 rifle and AK4047, and ample medical supplies."
	ai_to_spawn = list(
