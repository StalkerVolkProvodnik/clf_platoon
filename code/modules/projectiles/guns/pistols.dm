...
/obj/item/weapon/gun/pistol/m4a3/custom
	...
	desc = "Sporting a nickel finish and possibly faux ivory grip, this 9mm pistol has been customized by a well known gunsmith on Gateway Station. It offers no tactical advantages."
	icon_state = "m4a3c"
	item_state = "m4a3c"
...
/obj/item/weapon/gun/pistol/m4a3/m4a4
	...
	desc = "An M4A4 service pistol, a standard issue sidearm of the USCM, an updated special forces edition of the previous A3 model. Fires 9mm pistol rounds."
	icon = 'icons/obj/items/weapons/guns/guns_by_faction/uscm.dmi'
	icon_state = "m4a4"
	item_state = "m4a4"
	current_mag = /obj/item/ammo_magazine/pistol
