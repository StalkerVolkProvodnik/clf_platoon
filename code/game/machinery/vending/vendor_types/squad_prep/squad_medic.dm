...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Medical Backpack", 0, /obj/item/storage/backpack/marine/medic/imp, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_upp_medic, list(
		...
		list("BACKPACK (CHOOSE 1)", 0, null, null, null),
		list("Medical Backpack", 0, /obj/item/storage/backpack/marine/upp/medic, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),
		list("Medical Satchel", 0, /obj/item/storage/backpack/lightpack/upp, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
