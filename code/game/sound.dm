...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("jackboot")
				sound = pick('sound/items/jackboot1.ogg', 'sound/items/jackboot2.ogg', 'sound/items/jackboot3.ogg', 'sound/items/jackboot4.ogg', 'sound/items/jackboot5.ogg')
			if("heavy_jackboot")
				sound = pick('sound/items/heavy_jackboot1.ogg', 'sound/items/heavy_jackboot2.ogg', 'sound/items/heavy_jackboot3.ogg', 'sound/items/heavy_jackboot4.ogg')
			if("match")
			...
			if("gun_p90")
				sound = pick('sound/weapons/gun_FNP90_1.ogg', 'sound/weapons/gun_FNP90_2.ogg', 'sound/weapons/gun_FNP90_3.ogg')
			if("gun_f90")
				sound = pick('sound/weapons/gun_F90_1.ogg', 'sound/weapons/gun_F90_2.ogg', 'sound/weapons/gun_F90_3.ogg', 'sound/weapons/gun_F90_4.ogg')
			if("gun_ag80")
				sound = pick('sound/weapons/gun_ag80_1.ogg', 'sound/weapons/gun_ag80_2.ogg')
			//A:CM gun sounds
			...
			if("male_upp_warcry")
				sound = pick('sound/voice/upp_warcry/warcry_male_1.ogg', 'sound/voice/upp_warcry/warcry_male_2.ogg', 'sound/voice/upp_warcry/warcry_male_3.ogg', 'sound/voice/upp_warcry/warcry_male_4.ogg', 'sound/voice/upp_warcry/warcry_male_5.ogg', 'sound/voice/upp_warcry/warcry_male_6.ogg', 'sound/voice/upp_warcry/warcry_male_7.ogg', 'sound/voice/upp_warcry/warcry_male_8.ogg', 'sound/voice/upp_warcry/warcry_male_9.ogg', 'sound/voice/upp_warcry/warcry_male_10.ogg')
			if("male_portuguese_warcry")
				sound = pick('sound/voice/portuguese_warcry/warcry_male_1.ogg', 'sound/voice/portuguese_warcry/warcry_male_2.ogg', 'sound/voice/portuguese_warcry/warcry_male_3.ogg', 'sound/voice/portuguese_warcry/warcry_male_4.ogg', 'sound/voice/portuguese_warcry/warcry_male_5.ogg', 'sound/voice/portuguese_warcry/warcry_male_6.ogg', 'sound/voice/portuguese_warcry/warcry_male_7.ogg', 'sound/voice/portuguese_warcry/warcry_male_8.ogg')
			if("male_spanish_warcry")
				sound = pick('sound/voice/portuguese_warcry/warcry_male_1.ogg', 'sound/voice/portuguese_warcry/warcry_male_3.ogg', 'sound/voice/portuguese_warcry/warcry_male_4.ogg', 'sound/voice/portuguese_warcry/warcry_male_5.ogg', 'sound/voice/portuguese_warcry/warcry_male_6.ogg', 'sound/voice/portuguese_warcry/warcry_male_7.ogg', 'sound/voice/portuguese_warcry/warcry_male_8.ogg') // If someone finds more samples
			if("male_polish_warcry")
				sound = pick('sound/voice/polish_warcry/warcry_male_1.ogg', 'sound/voice/polish_warcry/warcry_male_2.ogg', 'sound/voice/polish_warcry/warcry_male_3.ogg', 'sound/voice/polish_warcry/warcry_male_4.ogg', 'sound/voice/polish_warcry/warcry_male_5.ogg', 'sound/voice/polish_warcry/warcry_male_6.ogg', 'sound/voice/polish_warcry/warcry_male_7.ogg', 'sound/voice/polish_warcry/warcry_male_8.ogg', )
			if("male_ruspatois_warcry")
				sound = pick('sound/voice/polish_warcry/warcry_male_1.ogg', 'sound/voice/polish_warcry/warcry_male_2.ogg', 'sound/voice/polish_warcry/warcry_male_3.ogg', 'sound/voice/polish_warcry/warcry_male_4.ogg', 'sound/voice/polish_warcry/warcry_male_5.ogg', 'sound/voice/polish_warcry/warcry_male_6.ogg', 'sound/voice/polish_warcry/warcry_male_7.ogg', 'sound/voice/polish_warcry/warcry_male_8.ogg', 'sound/voice/upp_warcry/warcry_male_5.ogg', 'sound/voice/upp_warcry/warcry_male_8.ogg', 'sound/voice/upp_warcry/warcry_male_9.ogg', 'sound/voice/upp_warcry/warcry_male_10.ogg') // If someone finds more samples
			if("male_german_warcry")
				sound = pick('sound/voice/german_warcry/warcry_male_1.ogg', 'sound/voice/german_warcry/warcry_male_2.ogg', 'sound/voice/german_warcry/warcry_male_3.ogg', 'sound/voice/german_warcry/warcry_male_4.ogg', 'sound/voice/german_warcry/warcry_male_5.ogg', 'sound/voice/german_warcry/warcry_male_6.ogg', 'sound/voice/german_warcry/warcry_male_7.ogg', 'sound/voice/german_warcry/warcry_male_8.ogg')
			if("male_scandinavian_warcry")
				sound = pick('sound/voice/german_warcry/warcry_male_1.ogg', 'sound/voice/german_warcry/warcry_male_2.ogg', 'sound/voice/german_warcry/warcry_male_4.ogg', 'sound/voice/german_warcry/warcry_male_5.ogg', 'sound/voice/german_warcry/warcry_male_6.ogg', 'sound/voice/german_warcry/warcry_male_7.ogg', 'sound/voice/german_warcry/warcry_male_8.ogg') // If someone finds more samples
			if("female_scream")
			...
			if("female_upp_warcry")
				sound = pick('sound/voice/upp_warcry/warcry_female_1.ogg', 'sound/voice/upp_warcry/warcry_female_2.ogg', 'sound/voice/upp_warcry/warcry_female_3.ogg', 'sound/voice/upp_warcry/warcry_female_4.ogg', 'sound/voice/upp_warcry/warcry_female_5.ogg', 'sound/voice/upp_warcry/warcry_female_6.ogg', 'sound/voice/upp_warcry/warcry_female_7.ogg', 'sound/voice/upp_warcry/warcry_female_8.ogg', 'sound/voice/upp_warcry/warcry_female_9.ogg')
			if("female_portuguese_warcry")
				sound = pick('sound/voice/portuguese_warcry/warcry_female_1.ogg', 'sound/voice/portuguese_warcry/warcry_female_2.ogg', 'sound/voice/portuguese_warcry/warcry_female_3.ogg', 'sound/voice/portuguese_warcry/warcry_female_4.ogg', 'sound/voice/portuguese_warcry/warcry_female_5.ogg', 'sound/voice/portuguese_warcry/warcry_female_6.ogg', 'sound/voice/portuguese_warcry/warcry_female_7.ogg', 'sound/voice/portuguese_warcry/warcry_female_8.ogg')
			if("female_spanish_warcry")
				sound = pick('sound/voice/portuguese_warcry/warcry_female_1.ogg', 'sound/voice/portuguese_warcry/warcry_female_2.ogg', 'sound/voice/portuguese_warcry/warcry_female_3.ogg', 'sound/voice/portuguese_warcry/warcry_female_4.ogg', 'sound/voice/portuguese_warcry/warcry_female_5.ogg', 'sound/voice/portuguese_warcry/warcry_female_6.ogg', 'sound/voice/portuguese_warcry/warcry_female_7.ogg', 'sound/voice/portuguese_warcry/warcry_female_8.ogg') // If someone finds more samples
			if("female_polish_warcry")
				sound = pick('sound/voice/polish_warcry/warcry_female_1.ogg', 'sound/voice/polish_warcry/warcry_female_2.ogg', 'sound/voice/polish_warcry/warcry_female_3.ogg', 'sound/voice/polish_warcry/warcry_female_4.ogg', 'sound/voice/polish_warcry/warcry_female_5.ogg', 'sound/voice/polish_warcry/warcry_female_6.ogg', 'sound/voice/polish_warcry/warcry_female_7.ogg', 'sound/voice/polish_warcry/warcry_female_8.ogg')
			if("female_ruspatois_warcry")
				sound = pick('sound/voice/polish_warcry/warcry_female_1.ogg', 'sound/voice/polish_warcry/warcry_female_2.ogg', 'sound/voice/polish_warcry/warcry_female_3.ogg', 'sound/voice/polish_warcry/warcry_female_4.ogg', 'sound/voice/polish_warcry/warcry_female_5.ogg', 'sound/voice/polish_warcry/warcry_female_6.ogg', 'sound/voice/polish_warcry/warcry_female_7.ogg', 'sound/voice/polish_warcry/warcry_female_8.ogg', 'sound/voice/upp_warcry/warcry_female_2.ogg', 'sound/voice/upp_warcry/warcry_female_3.ogg', 'sound/voice/upp_warcry/warcry_female_4.ogg') // If someone finds more samples
			if("female_german_warcry")
				sound = pick('sound/voice/german_warcry/warcry_female_1.ogg', 'sound/voice/german_warcry/warcry_female_2.ogg', 'sound/voice/german_warcry/warcry_female_3.ogg', 'sound/voice/german_warcry/warcry_female_4.ogg', 'sound/voice/german_warcry/warcry_female_5.ogg', 'sound/voice/german_warcry/warcry_female_6.ogg', 'sound/voice/german_warcry/warcry_female_7.ogg', 'sound/voice/warcry/warcry_female_8.ogg')
			if("female_scandinavian_warcry")
				sound = pick('sound/voice/german_warcry/warcry_female_2.ogg', 'sound/voice/german_warcry/warcry_female_4.ogg', 'sound/voice/german_warcry/warcry_female_6.ogg', 'sound/voice/german_warcry/warcry_female_7.ogg', 'sound/voice/warcry/warcry_female_8.ogg') // If someone finds more samples
			if("rtb_handset")
