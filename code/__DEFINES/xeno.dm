...
#define XENO_HEALTH_RUNNER 120 * XENO_UNIVERSAL_HPMULT // Killed by 1 PB
#define XENO_HEALTH_DRONE 180 * XENO_UNIVERSAL_HPMULT
#define XENO_HEALTH_SOLDIER 200 * XENO_UNIVERSAL_HPMULT
