...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_DROPSHIP_PILOT, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE))
...
GLOBAL_LIST_INIT(ROLES_RMCTROOP, list(JOB_TWE_RMC_LIEUTENANT, JOB_TWE_RMC_PILOT, JOB_TWE_RMC_TROOPLEADER, JOB_TWE_RMC_SECTIONLEADER, JOB_TWE_RMC_TEAMLEADER, JOB_TWE_RMC_BREACHER, JOB_TWE_RMC_SMARTGUNNER, JOB_TWE_RMC_MARKSMAN, JOB_TWE_RMC_ENGI, JOB_TWE_RMC_MEDIC, JOB_TWE_RMC_RIFLEMAN))
