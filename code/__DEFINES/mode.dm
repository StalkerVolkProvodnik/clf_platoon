...
GLOBAL_LIST_INIT(ROLES_MISC, list(JOB_SYNTH, JOB_WORKING_JOE, JOB_UPP_JOE, JOB_DI, JOB_CORPORATE_LIAISON, JOB_COMBAT_REPORTER, JOB_MESS_SERGEANT, JOB_WO_CORPORATE_LIAISON, JOB_WO_SYNTH))
...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_SISSI, SQUAD_UPP_AIRBORNE))
...
GLOBAL_LIST_INIT(ROLES_AI_UPP_FORECON, list(JOB_SQUAD_LEADER_FORECON_UPP, JOB_SQUAD_MEDIC_FORECON_UPP, JOB_SQUAD_TEAM_LEADER_FORECON_UPP, JOB_SQUAD_SMARTGUN_FORECON_UPP, JOB_SQUAD_MARINE_FORECON_UPP, JOB_SQUAD_RTO_FORECON_UPP))
GLOBAL_LIST_INIT(ROLES_AI_UPP_AIRBORNE, list(JOB_SO_UPP_AIRBORNE, JOB_SQUAD_LEADER_UPP_AIRBORNE, JOB_SQUAD_TEAM_LEADER_UPP_AIRBORNE, JOB_SQUAD_MEDIC_UPP_AIRBORNE, JOB_SQUAD_SMARTGUN_UPP_AIRBORNE, JOB_SQUAD_MARINE_UPP_AIRBORNE))
...
#define FACTION_UPPTG "UPP Territorial Guard"
...
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_IASF)
#define FACTION_LIST_ERT_OTHER list(FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO)
#define FACTION_LIST_ERT_ALL list(FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY, FACTION_CLF, FACTION_CONTRACTOR, FACTION_UPP, FACTION_FREELANCER, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_MARSHAL, FACTION_TWE, FACTION_IASF)
#define FACTION_LIST_WY list(FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY)
#define FACTION_LIST_UPP list(FACTION_UPP, FACTION_UPPTG)
#define FACTION_LIST_UPP_COLONY list(FACTION_COLONIST, FACTION_UPP, FACTION_UPPTG)
...
#define FACTION_LIST_TWE_REBEL list(FACTION_COLONIST, FACTION_TWE_REBEL, FACTION_IASF, FACTION_WY)
#define FACTION_LIST_UA_REBEL list(FACTION_COLONIST, FACTION_UA_REBEL)
#define FACTION_LIST_CANC list(FACTION_CANC)
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_PMC, FACTION_WY, FACTION_IASF)
