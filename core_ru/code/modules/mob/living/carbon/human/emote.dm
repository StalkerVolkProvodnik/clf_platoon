...
/datum/emote/living/carbon/human/warcry/get_sound(mob/living/user)
	...
	if(ishumansynth_strict(user))
		if(user.gender == MALE)
			...
			if(default_lang == GLOB.all_languages[LANGUAGE_PORTUGUESE])
				return get_sfx("male_portuguese_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_SPANISH])
				return get_sfx("male_spanish_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_POLISH])
				return get_sfx("male_polish_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_RUSPATOIS])
				return get_sfx("male_ruspatois_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_GERMAN])
				return get_sfx("male_german_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_SCANDINAVIAN])
				return get_sfx("male_scandinavian_warcry")
			else
		...
		if(user.gender == FEMALE)
			...
			if(default_lang == GLOB.all_languages[LANGUAGE_PORTUGUESE])
				return get_sfx("female_portuguese_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_SPANISH])
				return get_sfx("female_spanish_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_POLISH])
				return get_sfx("female_polish_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_RUSPATOIS])
				return get_sfx("female_ruspatois_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_GERMAN])
				return get_sfx("female_german_warcry")
			if(default_lang == GLOB.all_languages[LANGUAGE_SCANDINAVIAN])
				return get_sfx("female_scandinavian_warcry")
			else
